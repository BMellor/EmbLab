...
\usepackage[top=3cm,bottom=3cm,left=5cm,right=3cm,headsep=10pt,letterpaper,asymmetric]{geometry} % Page margins
...
\draw[anchor=west] (\Gm@lmargin-1.3cm,-3.7cm) node [line width=2pt,rounded corners=15pt,draw=rust,fill=white,fill opacity=0.75,inner sep=20pt]{\strut\makebox[22cm]{}};

\draw[anchor=west] (\Gm@lmargin-1cm,-3.8cm) node {\huge\sffamily\bfseries\color{black}{\relsize{4}\thechapter. }#1\strut};
